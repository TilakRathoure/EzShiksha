  ...
  const elements = [
    {
      ...
      img: formula,
      p: "Snap, solve. Math made easy. Revolutionize your learning!",
      ap: "/formula",
    },
    {
      ...
      <container className="flex flex-wrap gap-5 px-3 items-center justify-center pt-12 w-full h-full">
        {elements.map((e) => (
          <Link to={e.ap} className="no-underline">
            <div className="bg-white w-[100%] h-[350px] flex flex-col items-center justify-center rounded-2xl shadow-2xl p-4 hover:scale-105 transition translate-y-2 cursor-pointer gap-3">
              <img
                src={e.img}
              ...
              <p className="text-black leading-6">{e.p}</p>
            </div>
          </Link>
        ))}
      </container>
